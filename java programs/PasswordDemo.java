/**Write a Java program to design a screen using Awt that will take a user name and password. 
If the user name and password are not same, raise an exception with appropriate message. User can have 3 login chances only.
 Use clear 7 button to clear the text boxes. */
